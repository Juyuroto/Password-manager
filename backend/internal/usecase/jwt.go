...
type AuthRepository interface {
	DoesUserIDExist(userID int) (bool, error)
...
func (j JWTAuth) RefreshRefreshToken(refreshToken string) (*auth.Token, error) {
	...
	return &auth.Token{Access: updatedAccess, Refresh: updatedRefresh}, nil
}
